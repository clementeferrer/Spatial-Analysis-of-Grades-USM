...
prom_com_valp <- data.frame(gadm_valp_com$NAME_3, col_aux, col_aux, col_aux, col_aux, col_aux,
                            col_aux, col_aux, col_aux, col_aux)
names(prom_com_valp) <- c("Comuna", "FIS110", "IWI131", "MAT021", "MAT022","QUI010",
                          "IDP", "IDC", "RCP", "PPC")
